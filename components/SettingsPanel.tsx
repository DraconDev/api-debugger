        ...
        <div className="p-4 space-y-6">
          <div className="p-4 bg-muted/50 rounded-lg border border-border">
            ...
            <p className="text-sm text-muted-foreground">
              We never see your AI requests. Use your own API keys - no subscription to us needed.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 bg-card rounded-lg border border-border">
              ...
              <p className="text-xs text-muted-foreground">Works with enterprise OpenAI/Anthropic accounts</p>
            </div>
            <div className="p-3 bg-card rounded-lg border border-border">
              <div className="flex items-center gap-2 mb-1">
                <svg className="w-4 h-4 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-xs text-muted-foreground">Keys stored locally, calls go direct to AI</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                {settings.provider === "openai" && "Get your key from platform.openai.com/api-keys"}
                {settings.provider === "anthropic" && "Get your key from console.anthropic.com"}
                {settings.provider === "gemini" && "Get your key from aistudio.google.com/apikey"}
              </p>
            </div>
          ...
          <div className="pt-4 border-t border-border">
            <h4 className="text-sm font-medium mb-2">Where are my keys stored?</h4>
            <p className="text-sm text-muted-foreground">
              Keys are stored in Chrome's sync storage. They sync across your devices if Chrome sync is enabled.
              We never have access to your keys or AI conversations.
            </p>
          </div>
        </div>
      </div>
