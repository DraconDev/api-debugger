/* @ts-self-types="./dracon_wasm.d.ts" */
...
export class RateLimiter {
    ...
    check() {
        const ret = wasm.ratelimiter_check(this.__wbg_ptr);
        if (ret[1]) {
     ...
     */
    get_status() {
        const ret = wasm.ratelimiter_get_status(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} min_interval_ms
     * @param {number} max_per_hour
     */
    constructor(min_interval_ms, max_per_hour) {
        const ret = wasm.ratelimiter_new(min_interval_ms, max_per_hour);
 ...
 * @returns {any}
 */
export function extract_json(text) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.extract_json(ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function extract_json_from_markdown(markdown) {
    const ptr0 = passStringToWasm0(markdown, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.extract_json_from_markdown(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function validate_form_data(fields_json, values_json) {
    ...
    const ret = wasm.validate_form_data(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_log_1437e217d4d2c2e7: function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('dracon_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
